            ...
            <div class="header">
                    ...
                    <div class="modal-content">
                        ...
                        <form action="QuizGenerateController" method="get">
                            <div>
                                ...
                                border:none;
                                border-radius: 8px;
                                font-size: 24px;" type="submit" value="Tạo bài kiểm tra mới">
                        </div>
                        <div style=" margin-bottom: 20px;
                            ...
                            <p style="margin-top: 15px;
                               margin-left: 5px;
                               font-size: 20px;
                               font-weight: 200;">GIỚI HẠN CÂU HỎI </p>
                            <div>
                                <input style="outline: none;
                                       border-radius: 8px;
                                       border: none" type="text" name="courseID" value="${courseID}" hidden="">
                                       <input type="text" name="SubjectID" value="${SubjectID}" disabled="">
                                       <input style="width: 30px;
                                       padding-left: 10px;
                                       border:none;
                                       border-bottom: 1px solid orange;
                                       outline: none" type="text" name="questionNum" value="${quizQuestion.size()}">
                                       <input style="width: 40px;
                                       border:none;
                                       outline: none" type="text" id="id" value="/${maxQuestionNum}" disabled="">
                                </div>
                            </div>
                        </form>
                ...
                <div id="contentQuiz">
                    ...
                    <c:if test="${QuizNull == true}">
                        ...
                        color: red;
                        padding: 32px">Subject has no questions</h1>
                    </c:if>

                    <c:if test="${QuizNull == false}">
                        <div class="quizTable" style="width: 200px;
                        height: 300px;
                        position: fixed;
                        background: white;
                        border-radius: 8px;">
                        <c:forEach begin="0" end="${quizQuestion.size()-1}" step="1" var="i">
                            <button style="width: 20%;
                                    height: 20px;
                                    margin: 8px"><a href="#${i}" style="padding: 3px 14px;
                                 text-decoration: none;">${i+1}</a></button>
                            </c:forEach>
                        <input style="border:none;
                               ...
                               border-radius: 8px;
                               font-size: 15px;
                               cursor: pointer;" type="submit" form="frm" value="Kiểm Tra">
                    </div>
                    <div class="Quiz">
                        <form id="frm" action="QuizReviewController" method="post">
                            ...
                            <c:forEach begin="0" end="${quizQuestion.size()-1}" step="1" var="i">
                                <span>
                                    <div class="QuizQuestion" id="${i}">
                                        <p style="padding-top: 20px;
                                           ...
                                           margin-left: 50px;
                                           font-weight: 300;
                                           opacity: 0.8">Chọn đáp án đúng</p>
                                                    ...
                                                    <c:if test="${quizQuestion[i].getQuestionID() == answer.getQuestionID()}">
                                                        ...
                                                        <div style="margin-top: 80px;">
                                                            <input style="margin-right: 5px;
                                                                   width: 18px;
                                                                   height: 18px;" type="radio" id="answer${answer.getQuestionID()}" name="answer${answer.getQuestionID()}"
                                                        ...
                                                        <label 
                                                            ...
                                                            <p style="font-weight: 300;
                                                               font-size: 18px;
                                                               text-align: left;
                                                               line-height: 1.5">${answer.getContent()}</p> 
                                                            </label>
                                ...
                                border-radius: 8px;
                                font-size: 15px;
                                cursor: pointer;" type="submit" value="Kiểm Tra">
                        </form>
